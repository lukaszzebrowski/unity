...
public class RightDoor : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        openPosition = closedPosition + distance; // Ustal pozycjê otwart¹ (w prawo)
    }
    ...
    void Update()
    {
        ...
        if (isOpening)
        {
            // Przesuñ drzwi w prawo
            Vector3 move = Vector3.right * doorSpeed * Time.deltaTime;
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            Debug.Log("Drzwi otwieraj¹ siê w prawo.");
